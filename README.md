...
HTTPS or HyperText Transfer Protocol Secure, is a secure communications protocol that is used to transfer sensitive information between a website and a web server. Also using tokens to authenticate a user for logging into a protected page will help.
